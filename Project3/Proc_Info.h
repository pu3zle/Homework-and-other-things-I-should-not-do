...
typedef DWORD(_stdcall *pfnNtQueryInformationProcess)(
...
typedef struct _mRTL_USER_PROCESS_PARAMETERS {
    BYTE Reserved1[16];
    PVOID Reserved2[10];
    UNICODE_STRING ImagePathName;
    UNICODE_STRING CommandLine;
} mRTL_USER_PROCESS_PARAMETERS, * mPRTL_USER_PROCESS_PARAMETERS;
...
typedef struct _mPEB {
    ...
    PVOID Reserved3[2];
    PVOID Ldr;
    mPRTL_USER_PROCESS_PARAMETERS  ProcessParameters;
    BYTE Reserved4[104];
    PVOID Reserved5[52];
...
typedef struct _mPROCESS_BASIC_INFORMATION {
    LONG ExitStatus;
    mPPEB PebBaseAddress;
    ULONG_PTR AffinityMask;
    LONG BasePriority;
    ULONG_PTR UniqueProcessId;
    ULONG_PTR InheritedFromUniqueProcessId;
} mPROCESS_BASIC_INFORMATION, *mPPROCESS_BASIC_INFORMATION;
